    ...
    resource(buf)
{
    ...
    //    break;
    //case BufferType::kByteAdressBuffer:
    //    prop_type = MaterialPropertyType::kByteAddressBuffer;
    //    break;
    //case BufferType::kRWByteAdressBuffer:
    //    prop_type = MaterialPropertyType::kRWByteAddressBuffer;
    //    break;
    //default:
...
MaterialProperty::MaterialProperty(const ShaderParameter* param, const Color& color) :
    shader_param(param),
    prop_type(ConstantPropertyType::kColor),
    color(color)
{
}
...
MaterialProperty::MaterialProperty(const ShaderParameter* param, const Vec4f& float4) :
    shader_param(param),
    prop_type(ConstantPropertyType::kFloat4),
    float4(float4)
{
}
...
MaterialProperty::MaterialProperty(const ShaderParameter* param, const Matrix4x4& matrix) :
    shader_param(param),
    prop_type(ConstantPropertyType::kMatrix),
    matrix(matrix)
{
}
