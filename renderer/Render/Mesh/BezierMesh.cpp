...
GameObject& BezierMesh::CreatePlaneRoad(const BezierPath& curve, float half_width, Material* material, bool flatten) {
...
GameObject& BezierMesh::CreateRoad(const BezierPath& curve, float half_width, float thickness, Material* material, bool flatten) {
    VertexCollection vertices;
    IndexCollection indices;
...
GameObject& BezierMesh::CreateTube(const BezierPath& curve, float radius, int resolutionU, int resolutionV, Material* material) {
    VertexCollection vertices;
    IndexCollection indices;
