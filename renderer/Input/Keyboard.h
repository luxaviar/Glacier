...
public:
    ...
    public:
        ...
        bool IsKeyPressed(Keys key) const noexcept { return pressed.IsKeyDown(key); }
        bool IsKeyReleased(Keys key) const noexcept { return released.IsKeyDown(key); }
...
public:
    ...
    const KeyboardStateTracker& GetTracker() const { return tracker_; }
    ...
    bool IsJustKeyDown(Keys key) const;
    bool IsJustKeyUp(Keys key) const;
